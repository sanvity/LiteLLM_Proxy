...
# -----------------------------------------------------------------------
# PROXY_URL: The FastAPI backend URL.
# In Railway: set FASTAPI_URL env var to your FastAPI service's Railway URL.
...
if not configured_models:
    configured_models = ["primary-cluster", "backup-cluster"]
...
with tab_testing:
    ...
    user_query = st.text_area(
        ...
        value="I am Samuel, my phone numbers are +1 213 555-0123 and +91 9876534567, Aadhaar is 9988-7766-5544, SSN: 111-22-3333. My email is sam@gmail.com. Check which accounts are linked.",
        height=120
    )

    if st.button("Submit Request", type="primary"):
        payload = {
            "model": st.session_state.model_priorities[0] if st.session_state.model_priorities else "primary-cluster",
